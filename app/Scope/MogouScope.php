...
trait MogouScope
{
    ...
    {
        return $query->when(
            request('order_by_rating'), function ($query) {
    ...
    public function scopeFilterStatus($query,bool $orWhere = true)
    {
        ...
        return $query->when(
            $status, function ($query) use ($orWhere,$status) {
    ...
    {
        return $query->when(
            request('legal_only'), function ($query) {
    ...
    public function scopeByFinishStatus($query)
    {
        ...
        return $query->when(
            $finishStatus, function ($query) use ($finishStatus) {
    ...
    public function scopeByMogouType($query)
    {
        ...
        return $query->when(
            $mogouType, function ($query) use ($mogouType) {
    ...
    public function scopeFilterCategory($query,bool $orWhere = true)
    {
        ...
        return $query->when(
            $category, function ($query) use ($orWhere,$category) {
